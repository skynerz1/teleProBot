...
$token = "5146594441:AAGsyPNPSfVemhhS8Ncxa8V7mvbCSlSCN3g"; #توكنك
...
[['text' => "• رساله /start •", 'callback_data' => "editstart"]],
]])
]);   
}
...
[['text'=>"- قناة السورس .",'url'=>"t.me/KKY_R"],['text'=>"- المطور .",'url'=>"t.me/wgggk"]],
[['text'=>"- اضف البوت لقناتك .",'url'=>"https://t.me/u4aabot?startchannel"]],
]])]);}
if($data == "back" ){
...
◉ [المطور -](https://t.me/wgggk)  
◉ [القناه -](https://t.me/KKY_R)
